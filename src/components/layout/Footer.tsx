...
export function Footer() {
  ...
  return (
    <footer className="border-t border-dore/15 bg-beige-clair/60">
      <div className="mx-auto flex max-w-6xl flex-col gap-6 px-6 py-10 text-sm text-encre md:flex-row md:items-start md:justify-between">
        <div className="flex flex-col gap-2">
          <Link href={ROUTES.home} className="font-signature text-xl">
            Emilie Odjouoriby
          </Link>
